...
REM call :deploy_war "launchpad-war" "launchpad\build\launchpad\launchpad-war" "tmp7"
REM call :deploy_war "launchpad-apps-war" "launchpad-apps\build\launchpad-apps\launchpad-apps-war" "tmp8"
