...
call :deploy_war "sdc-war"      "ses\build\sdc\sdc-war"      "tmp7"
REM call :deploy_war "pos-server-war" "pos-server\build\pos-server\pos-server-war" "tmp1"
REM call :deploy_war "ucon-war" "ses\build\ucon\ucon-war" "tmp2"
REM call :deploy_war "launchpad-war" "launchpad\build\launchpad\launchpad-war" "tmp3"
REM REM call :deploy_war "launchpad-apps-war" "launchpad\build\launchpad-apps\launchpad-apps-war" "tmp4"
REM call :deploy_war "employee-hub-sandbox-war" "employee-hub\build\employee-hub-sandbox-war" "tmp6"
